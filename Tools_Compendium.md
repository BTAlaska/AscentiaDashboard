...
| Game World Asset Factory | Future P17/P23 non-structural world-asset quarantine intake, `EUW_AscentiaLODAndCollisionDoctor`, PCG provenance tags, Worldheart attachment metadata, and world-zone review | Generated static meshes remain external source material. Owner law assigns buildings and structural meshes to Worldheart; Meshy authors one atomic terrain/PCG mesh, prop, or reviewed decorative attachment while PCG/manual placement owns piles, fields, clusters, and dressing. The v4 catalog contains 129 archetypes and 1,229 review-compatible plans: 959 Meshy 7 Nanite-active, 90 T2-paused, and 180 historical review-only. Physical has 104 atomic geology archetypes spanning 111 active roles, with generated evidence for 110. Exact lithology job `world_1788446407577_45674c2dfb` preserved all 32 references, completed 31 review packages with 930 evidenced Meshy credits, and left one granite dome at an ambiguous no-task-ID submission failure without retry. The owner retained all 31 completed outputs. Providers are locked. Overall review stands at 107 Keep / 0 Reject / 46 awaiting across 153 eligible candidates. | No generated mesh may bypass `ImportQueue/WorldAssets`, source/task provenance, Blender QA, a separate result Keep, Unreal quarantine, and a human Nanite/PCG/Worldheart-mount verdict. Keep retains a candidate only. Any new provider call or retry requires fresh approval; T2, review-only composites, and structural output remain ineligible. |
...
3. Game World Asset Factory: all 60 exact corpus outputs and 31 completed
   lithology outputs are retained candidates after provider and Blender
   completion. Providers remain locked. Quarantine the 31-role
   basalt/sandstone/granite/marble result in Unreal, then obtain separate exact
   approval before reconciling or retrying the failed granite dome.
   The 29 structural packages remain historical quarantine. T2 is paused,
   Prompt Go never accepts a provider result, PCG owns rubble and debris
   composition, and Keep still requires later Unreal Nanite/PCG and
