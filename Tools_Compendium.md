...
| Game World Asset Factory | Future P17/P23 world-asset quarantine intake, `EUW_AscentiaLODAndCollisionDoctor`, PCG provenance tags, and world-zone review | Generated static meshes remain external source material. The human owner approved a hash-bound 120-asset Physical/Magical/Chilled batch capped at 2,295 Meshy credits. The first attempt completed 8 packages for 150 credits before Images 2 hit a billing hard limit; after the owner confirmed recovery, the exact 112-item remainder resumed for an estimated 2,145 credits. The local review surface separates complete Images 2 references from live 3D models, supports full-screen review, defaults 3D hue/material audit to unlit base color, offers a neutral all-white studio comparison, and links every landed card to its GLB and canonical ImportQueue package path. Blender warnings and all missing Unreal checks remain explicit debt. | No generated mesh may bypass `ImportQueue/WorldAssets`, source/task provenance, Blender QA, Unreal quarantine, and a human Nanite/PCG verdict. The active approval cannot expand to another theme, exceed 2,295 credits, authorize paid retries, or count provider completion as production acceptance. |
