...
| Game World Asset Factory | Future P17/P23 non-structural world-asset quarantine intake, `EUW_AscentiaLODAndCollisionDoctor`, PCG provenance tags, Worldheart attachment metadata, and world-zone review | Generated static meshes remain external source material. Owner law assigns buildings and structural meshes to Worldheart; Meshy authors one atomic terrain/PCG mesh, prop, or reviewed decorative attachment while PCG/manual placement owns piles, fields, clusters, and dressing. The locked v4 catalog contains 61 archetypes and 1,161 review-compatible plans: 981 active and 180 historical review-only. Physical has 57 active entries, including 36 new atomic geology forms. T2 is selective simple-background topology; foreground and hero/close assets use controlled or unremeshed Meshy 6 high-detail triangle recipes. Of 79 completed packages, 50 remain current non-structural candidates at 6 Keep / 0 Reject / 44 awaiting review; 29 structural results are historical quarantine only. The browser keeps actual generated evidence separate from forward recipes and supports unlit/studio, full-screen, GLB, and canonical package-path review. | No generated mesh may bypass `ImportQueue/WorldAssets`, source/task provenance, Blender QA, a separate result Keep, Unreal quarantine, and a human Nanite/PCG/Worldheart-mount verdict. Keep retains a candidate only. No old approval is valid; no job resumes without a new exact v4 user decision, hash, ID list, and cap. Review-only composites and structural results can never be promoted as Meshy-owned forward content. |
...
3. Game World Asset Factory: continue separate hash-bound Keep or Reject review
   ...
   geology prompt library, and require a new explicit v4 decision before any
   small pilot. Prompt Go never accepts a provider result, PCG owns rubble and
   debris composition, and Keep still requires later Unreal Nanite/PCG and
