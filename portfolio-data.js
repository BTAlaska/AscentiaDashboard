...
In D:\Ascentia\repos\game (follow the full bootstrap: AGENTS.md -> Docs/rules/SESSION_BOOTSTRAP.md -> Docs/COMPENDIUM_MAP.md -> the magic-lane rules): Aether is the REWARD layer — ETH is spell mana with Elden Ring rules; boss strikes deposit supersaturation residue; casts opportunistically consume charge for damage overcharge; the field drains toward the ambient norm; DepositSupersaturation energy is PER CELL (pool roughly 10x a per-cast request). Implement my decision in the field core and the designer surfaces described by Docs/Architecture/Aether_EnvironmentalMagic.md and Docs/DesignerSurfaces/AetherMagic_README.md, keep the Ascentia.Aether automation suite green and extend it to pin the new behavior, and verify multiplayer with the two-client fixture (-AscentiaNetAetherSmoke via Tools/network/run_two_client_aether_smoke.py; launch clients only after the driver prints START; the deplete sphere must stay wider than probe reach). Close out per Docs/rules/SOURCE_CONTROL.md (commit, push) plus the Portfolio Signal (update the ascentia entry, prune this hand-off).`,
  ...
  projects: [
    ...
    },
    {
      ...
      capability: '45 governed themes combine with 40 explicit geology, vegetation, architecture, ruin, prop, and landmark archetypes into 1,800 deterministic plans. The local browser exposes full GPT Image 2 prompts, exact Smart Topology/Retexture or higher-face Meshy 6 recipes, Unreal/PCG metadata, verdict capture, thumbnails, and working GLB previews. An Asset availability filter isolates 3D-ready models, reference-only images, or prompt-only plans. Asset details now provide mutually exclusive 3D model and complete Images 2 reference modes plus full-screen review for either. The checked-in Blender processor normalizes scale/pivot, inspects topology/materials, exports GLB/FBX, and renders four QA views.',
      proof: 'Commit c63ba14 on codex/game-world-factory fixes the narrow-window row compression and stacked preview layers, then adds full-screen reference/3D review. Browser verification at 837×1432 showed the complete 1536×1536 reference inside a 708×590 contained view and a full-screen 3D canvas resized to 2524×1462; TypeScript build, JavaScript syntax, catalog smoke, and diff checks pass. The first run completed 8 packages for 150 Meshy credits before billing_hard_limit_reached. The first exact-rerun plan, Chilled Cliff Outcrop, then completed GPT Image 2, Meshy, download, Blender processing, previews, and ImportQueue packaging with no job error. These are provider/Blender proofs, not acceptance.',
      blockers: [
      ...
      evidence: [
        ...
        'Git HEAD c63ba14; catalog hash b63ff4566d035346fd5a8f4c5b67c31b22abad78365c720262816d81621829eb; resumed jobs world_1784469518252_1ec9a83179, world_1784469751837_f703575bbc, and world_1784469752461_f7182c7a8d',
      ],
      snapshot: { branch: 'codex/game-world-factory', head: 'c63ba14', date: '2026-07-19', dirty: 0, ahead: null, behind: null },
    },
    {
      id: 'interfaceforge',
