...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    {
      level: 'attention',
      title: 'Worldheart: turn the first coherent R9 citadel into legible architecture',
      body: 'WH-WO-0062 attempt 0010 is the first technically admitted Mythic Core topology that reads as one citadel rather than the inherited R7/R8 butterfly: a rounded enclosure, continuous north/south palace spines, transverse gate halls, a curved occupied inner ward, five integrated construction families, and an inhabited drum-and-dome crown. It proves a 1,620 m direct span, a 1,943.534 m / 323.922 s route, 45 occupied floors, 24 vertical paths, 21.358 km of secondary walkability, one 364,228-triangle Nanite source, and 2,200 collision triangles without object exceptions or manual LODs. Direct review remains red: precinct envelopes are schematic, the dome over-dominates the body, and repeated crown/ward piers and arches collapse into player-height clutter. Continue at load/span hierarchy, clear sightlines, and program-specific envelope rules; do not patch attempt 0010, add manual LODs, conceal defects with cameras, or mutate Unreal.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
      ...
      title: 'Refine the first coherent Mythic Core R9 citadel',
      target: 'Codex - D:\\Ascentia\\repos\\worldheart',
      decision: false,
      why: 'R9 attempt 0010 proves the first coherent whole-citadel topology and multi-minute occupied circulation without object repair or manual LODs. Direct review isolates the next owning-system problem: uniform repeated crown/ward members erase hierarchy and player sightlines, while the five precinct envelopes still lack enough program-specific wall, opening, roof, room, infrastructure, and material depth.',
      prompt: String.raw`Continue WORLDHEART inside the active WH-WO-0062 R9 topology-reset lane. Do not treat attempt 0010 as gorgeous or visually accepted.

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0005.json, docs\worldheart\11_handoffs\WH-HANDOFF-0065_MYTHIC_CORE_R9_TOPOLOGY_SUBSTRATE.md, and only their routed dependencies. Inspect D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_citadel_r9\machine-attempt-0010, especially citadel_whole_r9.png, citadel_plan_r9.png, west_approach_r9.png, crown_player_r9.png, and institution_player_r9.png. Preserve attempts 0001-0010 as immutable evidence.

Preserve the 1,620 m direct span, exact 1,943.5335635259771 m / 323.92226058766283 s primary route, thirteen chapters, five integrated institutions, 45 occupied floors, 24 vertical paths, 21,357.654300062622 m secondary walkability, continuous enclosure/palace/gate/inner-ward topology, deterministic refusal/provenance, one Nanite source, and simple collision. Change the owning generator rules, not attempt 0010: derive primary/secondary/tertiary structural member spacing from span and load; reserve clear approach, threshold, overlook, and long-axis sightlines before emitting members; deepen archive, council, foundry, refuge, and cistern with distinct wall thickness, openings, rooms, courts, roofs, drainage, infrastructure, and material transitions; and rebalance crown footprint/body hierarchy. Lower object or triangle counts are acceptable when architectural clarity improves.

Reject object-by-object fixes, coordinate exception tables, decorative applique used as structure, manual LOD1/LOD2 chains, camera concealment, and hand-authored rescue. Keep Fable's compositions and repair ladder rejected; only its validated constructor recognition, polygon/self-intersection checks, deterministic refusal, and general curve/profile primitives remain salvageable. Manufacture only into a fresh append-only attempt under WORLDHEART_OUTPUT_PARENT. Inspect the whole, plan, west gate, crown arrival, and one institution interior before replay. Require focused native tests, warnings-as-errors builds, repository verification with inherited failures disclosed, and artifact hygiene. Keep architecture, gorgeousness, awe, wonder, Unreal readiness, and every affected gate red until direct authorized visual review. Do not mutate Unreal, Landscry, ThemeForge, providers, SitePainter, dressing-factory files, or unrelated dirty worktree files. Close with the governed Worldheart record first, then reconcile all three portfolio surfaces, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      state: 'attention',
      phase: 'WH-WO-0062 active - R9 topology technically admitted, direct visual acceptance withheld',
      summary: 'R9 attempt 0010 is the first Mythic Core result that reads as one walled axial citadel instead of the inherited R7/R8 butterfly. Continuous palace spines, transverse gate halls, a curved occupied inner ward, five integrated construction families, and an inhabited crown establish the right whole-building substrate. Direct review still rejects it because precinct envelopes are schematic, the dome over-dominates the body, and repeated crown/ward members destroy player-height hierarchy and sightlines.',
      focus: 'Preserve the admitted R9 whole-citadel topology, multi-minute route, connected occupation, five construction identities, Nanite source, and simple collision while deriving structural member hierarchy from span/load, reserving clear player sightlines, deepening each institution envelope, and rebalancing crown-to-body scale.',
      capability: 'The native R9 lane owns one 1,620 m rounded citadel enclosure, two continuous occupied longitudinal palace spines, two transverse gate halls, a curved inner ward, an inhabited drum-and-dome crown, and five integrated institution-specific construction modes. It generates the route, floors, vertical paths, round and program-specific rectilinear spans, roofs, vaults, buttresses, facade systems, collision, review views, and admission records from pregeometry plan rules. No object exception table, coordinate repair, or manual render LOD chain exists.',
      proof: 'R9 attempt 0010 carries 918 render objects, a 364,228-triangle Nanite source, 2,200 collision triangles, a 1,943.5335635259771 m route taking 323.92226058766283 s at 6 m/s across thirteen chapters, five construction modes, 45 occupied floors, 24 vertical paths, and 21,357.654300062622 m of secondary walkability. It reports zero disconnected floors, route intrusions, unresolved joints, program overlaps, straight substitutions, or manual corrections. Python compilation, warnings-as-errors application and test builds, the full native test executable, native admission, and diff checks pass. Replay is deliberately deferred after direct visual rejection. Direct inspection confirms a materially coherent whole and real walkable galleries, but not accepted institutional envelope depth, crown hierarchy, player sightline clarity, gorgeousness, awe, wonder, Unreal readiness, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'Uniform repeated crown and inner-ward piers/arches erase primary, secondary, and tertiary hierarchy and clutter the player sequence.',
        'Archive, council, foundry, refuge, and cistern need deeper program-specific wall, opening, room, court, roof, drainage, infrastructure, and material rules.',
        'The dome dominates the axial body instead of participating in an accepted crown-to-citadel hierarchy.',
      ...
      next: 'Continue the active WH-WO-0062 lane at span/load hierarchy, sightline reservation, institution envelope depth, and crown/body balance. Do not patch attempt 0010, add object exceptions or manual LODs, conceal defects with cameras, or import it into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md',
        'WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0005.json',
        'WH-HANDOFF-0065_MYTHIC_CORE_R9_TOPOLOGY_SUBSTRATE.md',
        'R9 plan sha256:0df53aa999dfc1b3204d496344d8702d327d3aab325cb70b11006513ffb80edc',
        'R9 artifact sha256:6c2a3411f1d990bc4da2ec0a211673d3ffd8ae46bc507ffccc94baf9303bf6c7',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0010',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: '51d61ea', date: '2026-08-06', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
