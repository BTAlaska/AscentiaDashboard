...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    },
    {
      ...
      body: 'WH-WO-0062 attempt 0050 is the strongest technically admitted Mythic Core substrate. It regenerates from an empty DCC scene as a 1,620 m stone, starmetal, and larimar citadel with a 1,943.534 m / 323.922 s primary route, 139 occupied floors, 53 vertical paths, and 52.559 km of secondary walkability. The four mantle-borne stair basilicas now own bonded sixteen-metre-deep walls, seventy-two spandrels, thirty-two landing-derived chambers and wall walks, thirty-two curved connectors, and four occupied hall-to-drum springing transepts. It uses one 1,026,636-triangle Nanite source plus 8,728 collision triangles with no output repair, straight substitution, object exception, or manual render LODs. Independent attempt 0051 reproduces the exact geometry and decoded review pixels. Direct review remains red: the cage problem is structurally solved, but the replacement reads as blank mass with openings too small to reveal its occupation; hall-to-dome springing, construction/material depth, lower galleries, and institutional interiors remain under-resolved. Continue through owning grammar; do not patch attempts 0050-0051, add manual LODs, conceal defects with cameras, or mutate Unreal/Landscry.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
      ...
      decision: false,
      why: 'R9 attempt 0050 proves generator-owned bonded stair-basilica walls with thirty-two landing-derived chambers and wall walks, thirty-two curved connectors, and four occupied hall-to-drum springing transepts. Independent attempt 0051 reproduces the exact GLB and decoded review pixels. Direct review confirms that the pier-cage failure is structurally solved while isolating the next owning-system problem: the generated occupation must become legible through chapel-scale wall sections, and the transepts must join the drum and ogival shell coherently.',
      prompt: String.raw`Continue WORLDHEART inside the active WH-WO-0062 R9 topology-reset lane. Do not treat attempt 0050 as gorgeous or visually accepted.

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0014.json, docs\worldheart\11_handoffs\WH-HANDOFF-0074_MYTHIC_CORE_R9_BONDED_INHABITED_STAIR_BASILICA_WALL_SUBSTRATE.md, and only their routed dependencies. Inspect D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_citadel_r9\machine-attempt-0050 and independent replay 0051, especially citadel_whole_r9.png, crown_silhouette_r9.png, central_crown_r9.png, drum_bay_r9.png, crown_player_r9.png, crown_shoulder_player_r9.png, south_enclosure_gallery_player_r9.png, west_approach_r9.png, crown_arrival_player_r9.png, archive_hall_player_r9.png, and foundry_hall_player_r9.png. Preserve attempts 0001-0051 as immutable evidence; attempts 0048 and 0049 are refused wall-section/spandrel failures, not repair material.

Preserve the 1,620 m direct span, exact 1,943.5335635259771 m / 323.92226058766283 s primary route, thirteen chapters, five integrated institutions, 139 occupied floors, 53 vertical paths, seven great halls/undercrofts/room sequences, 52.559 km secondary walkability, protected sightlines, true-void facades, layered enclosure walls, lower galleries, four five-tier mountain mantles, eighteen wall-borne curved quarry stairs, four mantle-borne stair basilicas, seventy-two hall daylight bays, sixty-four hall pylons, seventy-two bonded spandrels, eight monumental hall thresholds, thirty-two landing-derived wall chambers and walks, thirty-two curved landing connectors, four occupied cross-gabled springing transepts, sixteen bonded vault courses, twelve inhabited drum bays, three occupied drum levels, four ogival petals, one solid faceted stone spire, seventy-two program-owned detail modules, program clearances, deterministic refusal/provenance, one Nanite source, and simple collision. Preserve the visible material whitelist: obsidian gneiss, dressed stone, starmetal, and rare infrastructural larimar. Do not claim terrain integration without a pinned Landscry snapshot.

Change the owning plan and reusable generator rules, not attempts 0050-0051. Replace the tiny-slit effect and blank wall panels with chapel-scale recessed apertures and wall-chapel clusters derived from the actual landing/chamber section so the thirty-two generated chambers and walks read honestly. Preserve solid-to-void mass and the seven-bay hierarchy. Add construction-scale reveals, jambs, voussoirs, parapets, weathering, starmetal bearings, rare larimar infrastructure, and gravity drainage. Resolve each cross-gabled transept as a coherent structural and spatial springing into the drum and ogival shell. Couple the lower enclosure galleries, pointed arcade, chambers, daylight, drains, and wall walks so player views prove inhabited cliff architecture. Deepen program-owned architectural density in all five institutions without blocking circulation.
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      state: 'attention',
      phase: 'WH-WO-0062 active - R9 bonded inhabited stair-basilica wall substrate technically admitted; whole-citadel visual acceptance withheld',
      summary: 'R9 attempt 0050 regenerates the admitted 1.62 km citadel from an empty DCC scene with four broad mountain mantles and all sixteen curved shoulder ascents inside four monumental stair basilicas. The former pier cages are replaced by sixteen-metre-deep bonded walls with seventy-two pointed spandrels, thirty-two landing-derived chambers and wall walks, thirty-two curved connectors, and four occupied cross-gabled springing transepts. It preserves multi-minute traversal, connected occupation, protected sightlines, one Nanite source, and simple collision without output repair or manual LODs. Independent attempt 0051 reproduces the exact geometry and decoded review pixels. Direct review confirms structurally inhabited mass but rejects finished quality because blank panels and underscaled apertures hide the occupation; hall-to-dome springing, material depth, lower galleries, and institutional interiors still need professional resolution.',
      focus: 'Preserve the admitted whole-citadel topology, multi-minute route, connected occupation, mountain mantles, four monumental stair basilicas, inhabited wall chambers and walks, crown drum, masonry load paths, true-void facades, material whitelist, Nanite source, and simple collision while making the occupation legible through chamber-derived chapel apertures and resolving each cross-gabled transept into the drum and ogival shell through reusable plan rules.',
      capability: 'The native R9 lane owns one 1,620 m citadel enclosure, occupied palace spines, portal-broken gate palaces, a curved inner ward, five institution-specific construction modes, seven great halls and undercrofts, and an inhabited ogival crown. All sixteen curved shoulder flights occupy four mantle-borne stair basilicas whose sixteen-metre-deep walls generate seventy-two bonded spandrels, thirty-two landing-derived chambers, thirty-two intermediate walks, thirty-two curved connectors with separate collision, thirty-two chamber thresholds, and four occupied hall-to-drum transepts. It preserves four broad quadrant mantles, eight edge spines, four central load spines, twenty occupied terraces, a three-level crown drum, two lower galleries, and seventy-two program-owned modules. Deterministic material rules constrain visible output to obsidian gneiss, dressed stone, starmetal, and rare larimar. Blender begins from factory-empty state. No named-object exception, coordinate repair, straight substitution, output repair, or manual render LOD chain exists.',
      proof: 'R9 attempt 0050 carries a 1,026,636-triangle Nanite source, 8,728 collision triangles, a 1,943.5335635259771 m route taking 323.92226058766283 s at 6 m/s across thirteen chapters, 139 occupied floors, 53 vertical paths, and 52,559.453576837244 m of secondary walkability. It reports four stair halls, seventy-two hall daylight bays, sixty-four hall pylons, seventy-two bonded spandrels, eight monumental thresholds, thirty-two chambers, walks, curved connectors, and chamber thresholds, four occupied springing transepts, 396 pointed arch bays, 314 true-void facade bays, and nineteen honest review views. Independent attempt 0051 reproduces the exact GLB and decoded RGBA pixels; Blender/PNG container metadata nondeterminism is declared. Python syntax, two byte-identical warnings-as-errors application builds at 21ecb508, the clean warnings-as-errors test build at 26e08a8a, fresh full native suite, native admission, JSON validation, and diff checks pass. Repository verification has the same eight inherited unwaived failures. Direct review confirms systemic wall-occupation progress but not gorgeousness, awe, wonder, Unreal readiness, terrain integration, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'The pier cages are structurally replaced by bonded occupied walls, but blank panels and underscaled openings keep the thirty-two chambers and wall walks from reading honestly.',
        'Chapel-scale recessed apertures, chamber-derived section hierarchy, deep reveals, jambs, voussoirs, parapets, weathering, and material hierarchy remain under-resolved.',
        'Four occupied springing transepts exist, but their structural and spatial union with the crown drum and ogival shell remains schematic.',
      ...
      next: 'Continue the active WH-WO-0062 lane by replacing blank panels and tiny apertures with chamber-derived chapel-scale recessed openings that expose the generated wall occupation, then resolve each cross-gabled transept into the drum and ogival shell, deepen exterior construction and materials, honestly prove the lower galleries, and complete program-owned interiors. Change reusable plan and generator rules; do not patch attempts 0050-0051, add object exceptions or manual LODs, conceal defects with cameras, claim Landscry integration without a pinned snapshot, or import it into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md',
        'WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0014.json',
        'WH-HANDOFF-0074_MYTHIC_CORE_R9_BONDED_INHABITED_STAIR_BASILICA_WALL_SUBSTRATE.md',
        'Worldheart commit bc9d673 - Inhabit the Mythic Core basilica walls',
        'R9 plan sha256:4d1fb807c37ec7fd6cb9885c7fa41a579fbdc193d5f6f3fa6e87989325fe26bd',
        'R9 artifact sha256:e552850352b0e7aa86d3957304708d098c9fd493377886baf6abbd855606400c',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0050',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0051',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: 'bc9d673', date: '2026-08-06', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
