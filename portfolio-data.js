...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    {
      level: 'attention',
      title: 'Worldheart: resolve the R9 crown after chapel-wall admission',
      body: 'WH-WO-0062 attempt 0059 is the strongest technically admitted Mythic Core substrate. It regenerates from an empty DCC scene as a 1,620 m stone, starmetal, and larimar citadel with a 1,943.534 m / 323.922 s primary route, 139 occupied floors, 53 vertical paths, and 52.851 km of secondary walkability. Reusable wall-section rules now derive thirty-two chapel-scale apertures from actual stair landings, with seventy-two deep reveals, seventy-two layered voussoirs, forty section-valid clerestories, and eight bonded gable ends around the formerly isolated monumental arches. It uses one 1,178,348-triangle Nanite source plus 9,112 collision triangles with no output repair, straight substitution, object exception, or manual render LODs. Independent attempt 0060 reproduces the exact geometry and decoded review pixels. Direct review remains red: the generated occupation is much more legible and the gables are structurally bonded, but the gable screen is too dark and monolithic, whole-crown cadence still reads procedurally, crown-to-dome springing is unresolved, and construction/material depth, lower galleries, and institutional interiors remain under-resolved. Continue through owning grammar; do not patch attempts 0059-0060, add manual LODs, conceal defects with cameras, or mutate Unreal/Landscry.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
      ...
      title: 'Resolve the systemic Mythic Core R9 crown and gables',
      target: 'Codex - D:\\Ascentia\\repos\\worldheart',
      decision: false,
      why: 'R9 attempt 0059 proves generator-owned chamber-derived chapel walls with seventy-two deep reveals, seventy-two layered voussoirs, forty section-valid clerestories, and eight bonded gable ends. Independent attempt 0060 reproduces the exact GLB and decoded review pixels. Direct review confirms that occupation is more legible and the floating-gable failure is structurally solved while isolating the next owning-system problem: the bonded gable composition must become an inhabited crown-to-dome springing instead of a dark monolithic screen.',
      prompt: String.raw`Continue WORLDHEART inside the active WH-WO-0062 R9 topology-reset lane. Do not treat attempt 0059 as gorgeous or visually accepted.

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0015.json, docs\worldheart\11_handoffs\WH-HANDOFF-0075_MYTHIC_CORE_R9_CHAMBER_DERIVED_CHAPEL_AND_BONDED_GABLE_SUBSTRATE.md, and only their routed dependencies. Inspect D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_citadel_r9\machine-attempt-0059 and independent replay 0060, especially citadel_whole_r9.png, crown_silhouette_r9.png, central_crown_r9.png, drum_bay_r9.png, crown_player_r9.png, crown_shoulder_player_r9.png, south_enclosure_gallery_player_r9.png, west_approach_r9.png, crown_arrival_player_r9.png, archive_hall_player_r9.png, and foundry_hall_player_r9.png. Preserve attempts 0001-0060 as immutable evidence; attempts 0052, 0053, 0054, 0056, and 0057 are refused development evidence, not repair material.

Preserve the 1,620 m direct span, exact 1,943.5335635259771 m / 323.92226058766283 s primary route, thirteen chapters, five integrated institutions, 139 occupied floors, 53 vertical paths, seven great halls/undercrofts/room sequences, 52.851 km secondary walkability, protected sightlines, true-void facades, layered enclosure walls, lower galleries, four five-tier mountain mantles, eighteen wall-borne curved quarry stairs, four mantle-borne stair basilicas, seventy-two hall daylight bays, sixty-four hall pylons, eighty bonded spandrels, eight monumental hall thresholds, thirty-two landing-derived wall chambers and walks, thirty-two curved landing connectors, thirty-two chapel-scale apertures, forty section-valid clerestories, seventy-two deep reveals, seventy-two layered voussoirs, eight bonded gable ends, four occupied cross-gabled springing transepts, sixteen bonded vault courses, twelve inhabited drum bays, three occupied drum levels, four ogival petals, one solid faceted stone spire, seventy-two program-owned detail modules, program clearances, deterministic refusal/provenance, one Nanite source, and simple collision. Preserve the visible material whitelist: obsidian gneiss, dressed stone, starmetal, and rare infrastructural larimar. Do not claim terrain integration without a pinned Landscry snapshot.

Change the owning plan and reusable generator rules, not attempts 0059-0060. Turn each bonded gable from a dark planar screen into a load-bearing, occupiable crown-to-dome springing with coherent depth hierarchy, triforium or gallery occupation, section-derived daylight, buttress/load transfer, layered stone construction, starmetal bearings, restrained larimar infrastructure, and a legible junction with the drum and ogival shell. Preserve the chamber-derived chapel rules and broad bay rhythm while breaking procedural repetition through institution, structure, approach, and section rather than coordinate exceptions. Couple the lower enclosure galleries, pointed arcade, chambers, daylight, drains, and wall walks so player views prove inhabited cliff architecture. Deepen program-owned architectural density in all five institutions without blocking circulation.
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      state: 'attention',
      phase: 'WH-WO-0062 active - R9 chamber-derived chapel and bonded-gable substrate technically admitted; whole-citadel visual acceptance withheld',
      summary: 'R9 attempt 0059 regenerates the admitted 1.62 km citadel from an empty DCC scene with four broad mountain mantles and all sixteen curved shoulder ascents inside four monumental stair basilicas. Reusable wall-section rules derive thirty-two chapel-scale apertures from the actual stair landings, with full-depth jambs and reveal floors, seventy-two deep reveals, seventy-two layered voussoirs, forty section-valid clerestories, and eight bonded gable ends around the formerly isolated monumental arches. It preserves multi-minute traversal, connected occupation, protected sightlines, one Nanite source, and simple collision without output repair or manual LODs. Independent attempt 0060 reproduces the exact geometry and decoded review pixels. Direct review confirms more legible occupation and structurally bonded gables but rejects finished quality because the gable screen is still too dark and monolithic, whole-crown cadence remains procedural, crown-to-dome springing is unresolved, and material depth, lower galleries, and institutional interiors still need professional resolution.',
      focus: 'Preserve the admitted whole-citadel topology, multi-minute route, connected occupation, mountain mantles, four monumental stair basilicas, chamber-derived chapel walls, crown drum, masonry load paths, true-void facades, material whitelist, Nanite source, and simple collision while turning each bonded gable into an inhabited, structurally legible crown-to-dome springing through reusable plan and section rules.',
      capability: 'The native R9 lane owns one 1,620 m citadel enclosure, occupied palace spines, portal-broken gate palaces, a curved inner ward, five institution-specific construction modes, seven great halls and undercrofts, and an inhabited ogival crown. All sixteen curved shoulder flights occupy four mantle-borne stair basilicas whose reusable wall sections generate eighty bonded spandrels, thirty-two landing-derived chambers, thirty-two intermediate walks, thirty-two curved connectors with separate collision, thirty-two chapel-scale apertures, forty section-valid clerestories, seventy-two deep reveals, seventy-two layered voussoirs, and eight bonded gable ends. It preserves four broad quadrant mantles, eight edge spines, four central load spines, twenty occupied terraces, a three-level crown drum, two lower galleries, and seventy-two program-owned modules. Deterministic material rules constrain visible output to obsidian gneiss, dressed stone, starmetal, and rare larimar. Blender begins from factory-empty state. No named-object exception, coordinate repair, straight substitution, output repair, or manual render LOD chain exists.',
      proof: 'R9 attempt 0059 carries a 1,178,348-triangle Nanite source, 9,112 collision triangles, a 1,943.5335635259771 m route taking 323.92226058766283 s at 6 m/s across thirteen chapters, 139 occupied floors, 53 vertical paths, and 52,850.71757683721 m of secondary walkability. It reports four stair halls, seventy-two hall daylight bays, sixty-four hall pylons, eighty bonded spandrels, eight monumental thresholds, thirty-two chambers and chapel apertures, forty clerestories, seventy-two deep reveals and layered voussoirs, eight bonded gables, 396 pointed arch bays, 314 true-void facade bays, and nineteen honest review views. Independent attempt 0060 reproduces the exact plan, GLB, report, topology, route proof, review HTML, and decoded RGBA pixels; Blender/PNG container metadata nondeterminism is declared. Python syntax, two byte-identical warnings-as-errors application builds at b1fc8db6, the clean warnings-as-errors test build at b697f05f, fresh full native suite, native admission, JSON validation, and diff checks pass. Repository verification has the same eight inherited unwaived failures. Direct review confirms systemic chapel/gable progress but not gorgeousness, awe, wonder, Unreal readiness, terrain integration, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'The chamber-derived chapel apertures now expose the wall occupation, but the bonded gable screen remains too dark, monolithic, and sparsely articulated.',
        'Whole-crown bay rhythm still reads procedurally at distance instead of expressing institution, approach, structure, and occupation.',
        'Bonded gables and occupied springing transepts exist, but their structural and spatial union with the crown drum and ogival shell remains schematic.',
      ...
      next: 'Continue the active WH-WO-0062 lane by turning each bonded gable from a dark planar screen into a load-bearing, occupiable crown-to-dome springing, varying whole-crown cadence through institution and section, deepening exterior construction and materials, honestly proving the lower galleries, and completing program-owned interiors. Change reusable plan and generator rules; do not patch attempts 0059-0060, add object exceptions or manual LODs, conceal defects with cameras, claim Landscry integration without a pinned snapshot, or import it into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md',
        'WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0015.json',
        'WH-HANDOFF-0075_MYTHIC_CORE_R9_CHAMBER_DERIVED_CHAPEL_AND_BONDED_GABLE_SUBSTRATE.md',
        'Worldheart commit 315d7dd - Deepen Mythic Core chapel walls and gables',
        'R9 plan sha256:b04fef8d74778b68a086c375d6c304fb71f8d3642a242db692be79755fbba3e7',
        'R9 artifact sha256:b89fe41a65c707bf6d1e912b033cacf032cae88de73722b747c4c36eee69fd1a',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0059',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0060',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: '315d7dd', date: '2026-08-06', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
