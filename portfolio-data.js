...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    {
      level: 'attention',
      title: 'Worldheart: deepen the systemic R9 citadel into Apex architecture',
      body: 'WH-WO-0062 attempt 0047 is the strongest technically admitted Mythic Core substrate. It regenerates from an empty DCC scene as a 1,620 m stone, starmetal, and larimar citadel with a 1,943.534 m / 323.922 s primary route, 103 occupied floors, 53 vertical paths, and 50.796 km of secondary walkability. The sixteen curved shoulder ascents now occupy four mantle-borne monumental stair basilicas under shared near-level ogival roofs, with roughly 170 m outer naves, 168 height-derived pointed daylight bays, eighty cliff pylons, eight monumental thresholds, structural drainage, and larimar wayfinding. It uses one 1,027,932-triangle Nanite source plus 6,968 collision triangles with no output repair, straight substitution, object exception, or manual render LODs. Direct review confirms a substantially grander and more spatially legible crown but remains red: the hall sides are too pier-cage-like, bonded spandrels and intermediate occupation are incomplete, and hall-to-dome bonding, material depth, lower galleries, and institutional interiors remain under-resolved. Continue by changing owning grammar; do not patch attempt 0047, add manual LODs, conceal defects with cameras, or mutate Unreal/Landscry.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
      ...
      title: 'Deepen the systemic Mythic Core R9 citadel',
      target: 'Codex - D:\\Ascentia\\repos\\worldheart',
      decision: false,
      why: 'R9 attempt 0047 proves that sixteen curved ascents can be grouped inside four mantle-borne monumental stair basilicas with shared near-level roofs, roughly 170 m outer naves, height-derived daylight tiers, cliff pylons, monumental thresholds, drainage, and larimar wayfinding, all regenerated from an empty scene without output repair or manual LODs. Direct review confirms that the stacked-gallery failure is solved and the crown experience is substantially grander, while isolating the next owning-system problem: the tall pier cages must become bonded inhabited masonry and the halls must spring coherently into the drum and dome.',
      prompt: String.raw`Continue WORLDHEART inside the active WH-WO-0062 R9 topology-reset lane. Do not treat attempt 0047 as gorgeous or visually accepted.

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0013.json, docs\worldheart\11_handoffs\WH-HANDOFF-0073_MYTHIC_CORE_R9_MANTLE_BORNE_MONUMENTAL_STAIR_BASILICA_SUBSTRATE.md, and only their routed dependencies. Inspect D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_citadel_r9\machine-attempt-0047, especially citadel_whole_r9.png, crown_silhouette_r9.png, central_crown_r9.png, drum_bay_r9.png, crown_player_r9.png, crown_shoulder_player_r9.png, south_enclosure_gallery_player_r9.png, west_approach_r9.png, crown_arrival_player_r9.png, archive_hall_player_r9.png, and foundry_hall_player_r9.png. Preserve attempts 0001-0047 as immutable evidence; attempts 0045 and 0046 are admitted roof-section visual comparisons, not repair material.

Preserve the 1,620 m direct span, exact 1,943.5335635259771 m / 323.92226058766283 s primary route, thirteen chapters, five integrated institutions, 103 occupied floors, 53 vertical paths, seven great halls/undercrofts/room sequences, 50.796 km secondary walkability, explicit structural hierarchy, protected sightlines, true-void facades, layered enclosure walls, two occupied wall walks, two lower galleries with 132 pointed bays, four broad five-tier mountain mantles, eight mantle edge spines, twenty occupied crown terraces, eighteen wall-borne curved quarry stairs, four mantle-borne stair basilicas with four shared near-level roofs, 168 hall daylight bays, eighty hall pylons, eight monumental hall thresholds, thirty-six landings and gallery thresholds, eighteen starmetal drains, thirty-six larimar beacons, sixteen bonded vault courses, four occupied springing bridges, four faceted masonry load spines, twelve inhabited drum bays, twenty-four deep two-storey pointed openings, four cardinal drum portals, three occupied drum levels, four separated ogival petals, one solid faceted stone spire, seventy-two program-owned detail modules, program clearances, portal-broken gate palaces, pointed ceremonial thresholds, deterministic refusal/provenance, one Nanite source, and simple collision. Preserve the visible material whitelist: obsidian gneiss, dressed stone, starmetal, and rare infrastructural larimar. Do not claim terrain integration without a pinned Landscry snapshot.

Change the owning plan and reusable generator rules, not attempt 0047. Turn each tall pier cage into bonded inhabited mantle architecture: generate structurally continuous spandrels, thick wall chambers, and route-connected intermediate wall walks derived from the existing stair landings. Resolve each hall inner end as a true springing transept bonded into the drum and ogival shell instead of an abrupt roof overlap. Preserve the cathedral-scale outer gable void and switchback nave while establishing clear primary, secondary, and tertiary construction hierarchy. Increase depth through voussoirs, parapets, wall and roof buildup, starmetal bearings, rare larimar infrastructure, drainage, and weathering. Couple the lower enclosure galleries, pointed arcade, chambers, daylight, drains, and wall walks so player views prove inhabited cliff architecture honestly. Deepen program-owned architectural density in all five institutions without blocking circulation.

Reject object-by-object fixes, coordinate exception tables, decorative applique used as structure, manual LOD1/LOD2 chains, camera concealment, and hand-authored rescue. Keep only the salvaged deterministic constructors, validation, refusal, provenance, topology, circulation, institutional builders, and curve/profile substrate from Fable; do not restore its visible composition or repair ladder. Manufacture only into a fresh append-only attempt under WORLDHEART_OUTPUT_PARENT. Inspect the whole, plan, gates, crown silhouette, shoulder circulation, enclosure gallery, crown arrival, archive hall, and foundry hall before replay. Require Python syntax, diff checks, focused and full native tests, two warnings-as-errors builds, repository verification with inherited failures disclosed, and artifact hygiene. Keep architecture, gorgeousness, awe, wonder, Unreal readiness, and every affected gate red until direct authorized visual review. Do not mutate Unreal, Landscry, ThemeForge, providers, SitePainter, dressing-factory files, or unrelated dirty worktree files. Close with the governed Worldheart record first, then reconcile all three portfolio surfaces, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      snapshot: { branch: 'agent/s1-sediment', head: 'e6f3486', date: '2026-08-06', dirty: 0, ahead: 0, behind: 0 },
    },
    {
      id: 'worldheart',
      name: 'Worldheart',
      ...
      state: 'attention',
      phase: 'WH-WO-0062 active - R9 mantle-borne monumental stair-basilica substrate technically admitted; whole-citadel visual acceptance withheld',
      summary: 'R9 attempt 0047 regenerates the admitted 1.62 km citadel from an empty DCC scene with four broad mountain mantles and all sixteen curved shoulder ascents housed inside four mantle-borne monumental stair basilicas. Shared near-level ogival roofs create roughly 170 m outer naves above the switchback flights, while height-derived facades provide 168 pointed daylight bays, eighty cliff pylons, eight monumental thresholds, gravity drainage, and larimar wayfinding. It preserves multi-minute traversal, connected occupation, protected sightlines, one Nanite source, and simple collision without output repair or manual LODs. Direct review confirms a substantially grander crown and spatially legible stair-hall experience but rejects finished quality because the tall hall sides remain pier-cage-like, bonded spandrels and intermediate occupation are incomplete, and hall-to-dome bonding, material depth, lower galleries, and institutional interiors still need professional resolution.',
      focus: 'Preserve the admitted whole-citadel topology, multi-minute route, connected occupation, mountain mantles, four monumental stair basilicas, inhabited crown drum, masonry load paths, explicit hierarchy, clear gates, true-void facades, program clearances, material whitelist, Nanite source, and simple collision while converting the tall hall cages into bonded inhabited masonry and resolving their springing into the drum and ogival shell through reusable plan rules.',
      capability: 'The native R9 lane owns one 1,620 m citadel enclosure, occupied palace spines, portal-broken gate palaces, a curved inner ward, five institution-specific construction modes, seven great halls and undercrofts, and an inhabited ogival crown. It now groups all sixteen curved shoulder flights inside four mantle-borne radial stair basilicas under shared inner-springing near-level roofs. The halls derive local clear height, up to four daylight tiers, and monumental thresholds from one section law, producing 168 pointed hall bays, eighty full-height cliff pylons, eight gable thresholds, continuous stone plinths and roof bearings, starmetal gravity drains, and larimar scour basins. It preserves thirty-six occupied landings and gallery thresholds, four broad quadrant mantles, eight edge spines, four central load spines, four springing bridges, twenty occupied terraces, a three-level crown drum, two lower galleries, and seventy-two program-owned modules. Deterministic material rules constrain visible output to obsidian gneiss, dressed stone, starmetal, and rare larimar. Blender begins from factory-empty state. No named-object exception, coordinate repair, straight substitution, output repair, or manual render LOD chain exists.',
      proof: 'R9 attempt 0047 carries a 1,027,932-triangle Nanite source, 6,968 collision triangles, a 1,943.5335635259771 m route taking 323.92226058766283 s at 6 m/s across thirteen chapters, five construction modes, 103 occupied floors, 53 vertical paths, and 50,796.2641918655 m of secondary walkability. It reports four inhabited stair halls, 168 hall daylight bays, eighty hall pylons, eight monumental hall thresholds, four shared ridge roofs, thirty-six landings and gallery thresholds, eighteen drains, thirty-six larimar beacons, sixteen bonded vault courses, 460 pointed arch bays, 378 true-void facade bays, and nineteen honest review views. Python syntax, two byte-identical warnings-as-errors application builds at 2752bbce, a warnings-as-errors test build, the fresh full native suite, native admission, JSON validation, and diff checks pass. Repository verification has the same eight inherited unwaived failures. Direct review confirms systemic monumental-circulation progress but not gorgeousness, awe, wonder, Unreal readiness, terrain integration, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'The stacked roof bands are gone and four monumental halls now organize the crown, but their tall sides still read as pier cages rather than bonded inhabited mantle walls.',
        'Structurally continuous spandrels, thick chambers, and route-connected intermediate wall walks are missing from the new halls.',
        'Hall-to-drum springing, exterior bonded wall depth, voussoirs, parapets, roof and wall buildup, starmetal bearings, weathering, and material hierarchy remain under-resolved.',
        ...
        'No visually accepted R9 artifact, independent replay, clean Unreal import, or final material/lighting proof exists.',
      ...
      next: 'Continue the active WH-WO-0062 lane by converting the four tall stair-hall pier cages into bonded inhabited masonry with spandrels, chambers, and route-connected wall walks, then resolve their inner springing into the drum and ogival shell, deepen exterior construction and materials, honestly prove the lower galleries, and complete program-owned interiors. Change reusable plan and generator rules; do not patch attempt 0047, add object exceptions or manual LODs, conceal defects with cameras, claim Landscry integration without a pinned snapshot, or import it into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md',
        'WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0013.json',
        'WH-HANDOFF-0073_MYTHIC_CORE_R9_MANTLE_BORNE_MONUMENTAL_STAIR_BASILICA_SUBSTRATE.md',
        'Worldheart commit 4f9897e - Raise the Mythic Core stair basilicas',
        'R9 plan sha256:87620aa26e46406fd180c3de4eea782d5c836ef5695e49369cb2048f6e9ba64c',
        'R9 artifact sha256:66ca69251af2e0e24265a28ce6c35a48f69b45b4d550b09f74380f970556eb2c',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0047',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: '4f9897e', date: '2026-08-06', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
