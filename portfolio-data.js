...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    {
      level: 'attention',
      title: 'Worldheart: reshape the R9 outer gable from the inhabited-loggia checkpoint',
      body: 'WH-WO-0062 attempt 0073 is the strongest technically admitted Mythic Core foundation. It regenerates from an empty DCC scene as a 1,920 x 1,120 x 702 m stone, starmetal, and larimar citadel with a 1,620 m direct span, 1,943.534 m / 323.922 s route, 151 occupied floors, 65 vertical paths, and 54.992 km of secondary walkability. Shared rules now generate eight occupied two-level central-gable loggias with eight landing accesses, twenty-four true-void bays and recessed starmetal bearings, eight battered load shoulders, and program-differentiated narthex screens while preserving the perforated gables, curved circulation, roof galleries, bonded flank chapels, and gable-to-dome springing system. It uses one 1,354,604-triangle Nanite source plus 9,672 collision triangles with no output repair, straight substitution, object exception, or manual render LODs. Independent attempt 0074 reproduces the exact GLB and all nineteen decoded review images. Direct review remains red: the central composition is wider, deeper, and better grounded, but the outer gable still reads as a rectangular front below its roof, the arrival exposes a diagonal stair crossing as machinery, and gable-to-dome union, interiors, and player staging remain under-resolved. Continue through owning grammar; do not patch attempts, add manual LODs, conceal defects with cameras, or mutate Unreal/Landscry.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
      ...
      title: 'Resolve the systemic Mythic Core R9 outer gable from attempt 0073',
      target: 'Codex - D:\\Ascentia\\repos\\worldheart',
      decision: false,
      why: 'R9 attempt 0073 proves generator-owned two-level central-gable loggias, landing access, recessed starmetal bearings, battered load shoulders, and differentiated narthex screens. Independent attempt 0074 reproduces the exact GLB and decoded review pixels. Direct review preserves this as the strongest current foundation while isolating the next owning-system problem: replace the rectangular outer-gable front and exposed stair crossing with a convincing inhabited cliff-load section tied into the crown.',
      prompt: String.raw`Continue WORLDHEART inside the active WH-WO-0062 R9 topology-reset lane. Do not treat attempt 0073 as gorgeous or visually accepted.

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260807-0017.json, docs\worldheart\11_handoffs\WH-HANDOFF-0077_MYTHIC_CORE_R9_INHABITED_LOGGIA_AND_LOAD_SHOULDER_SUBSTRATE.md, and only their routed dependencies. Inspect attempt 0073 and independent replay 0074 under D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_citadel_r9, especially citadel_whole_r9.png, crown_silhouette_r9.png, central_crown_r9.png, crown_player_r9.png, crown_shoulder_player_r9.png, crown_arrival_player_r9.png, south_enclosure_gallery_player_r9.png, west_approach_r9.png, archive_hall_player_r9.png, and foundry_hall_player_r9.png. Preserve attempts 0001-0074 as immutable evidence; earlier attempts are development evidence, not repair material.

Preserve the 1,620 m direct span, exact 1,943.5335635259771 m / 323.92226058766283 s primary route, thirteen chapters, five integrated institutions, 151 occupied floors, 65 vertical paths, 54.992 km secondary walkability, protected sightlines, true-void facades, layered enclosure walls, mountain mantles, wall-borne curved quarry stairs, four mantle-borne stair basilicas, eight occupied central-gable loggias and accesses, twenty-four recessed starmetal bearings, eight battered load shoulders, differentiated narthex screens, twenty-four gable triforia, four occupied roof galleries and curved accesses, twelve gable-to-dome springing ribs, twenty-four bonded flank-chapel voids, crown drum, ogival dome, deterministic refusal/provenance, one Nanite source, and simple collision. Preserve the visible material whitelist: obsidian gneiss, dressed stone, starmetal, and rare infrastructural larimar. Keep the semi-Gothic brutalist language grounded in stone, mountain, cliff, ridge, and quarried-mantle morphology. Do not claim terrain integration without a pinned Landscry snapshot.

Change the owning plan and reusable generator rules, not attempts 0073-0074. Replace the rectangular outer-gable front with a battered, stepped masonry section whose occupied loggias, flank chapels, eaves, roof, and load shoulders grow from one cliff-load profile. Turn the visible diagonal stair crossing into an inhabited bridge, vaulted crossing, or enclosed landing hall derived from authentic circulation and section; do not hide it with a screen or camera. Resolve gable-to-dome and hall-to-crown construction as one material/load-transfer system with real daylight consequences. Break repetition through program, approach, structure, and section rather than coordinate exceptions. Continue lower galleries and program-owned interiors without blocking circulation.
...
In D:\Ascentia (read ops\ARTIFACT_HYGIENE.md first): delete ONLY the approved cache-class paths. Laws: repos\landscry\unreal\Binaries is generated-state, NOT cache — if I listed it, first prove a clean rebuild of the winding-fixed importer DLLs; never touch evidence/artifact/generated-state classes under a cache approval; before deleting a tree's caches confirm no editor or build is running against it (any open UE 5.8 editor blocks builds repo-wide via the Live Coding mutex); UE recreates DDC/Intermediate on demand so the directories can go entirely. Afterwards run the full refresh (refresh-portfolio.ps1) and report the reclaimed GB from the Hygiene tiles, before/after. Close out with the Portfolio Signal (update this hand-off or prune it).`,
    ...
    {
      id: 'landscry-gpu-r8',
      title: 'GPU fjord lane round 2: organic skeleton (r8), glacial instrument, SED-08 commit',
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      state: 'attention',
      phase: 'WH-WO-0062 active - R9 occupied central-gable loggia and battered load-shoulder substrate technically admitted; whole-citadel visual acceptance withheld',
      summary: 'R9 attempt 0073 regenerates the admitted Apex citadel from an empty DCC scene with eight occupied two-level central-gable loggias and landing accesses, twenty-four true-void loggia bays and recessed starmetal bearings, eight battered load shoulders, and differentiated processional/service narthex screens. It preserves the perforated gable roofs, curved roof-gallery access, continuous flank-chapel masonry, multi-minute traversal, connected occupation, protected sightlines, one Nanite source, and simple collision without output repair or manual LODs. Independent attempt 0074 reproduces the exact geometry and decoded review pixels. Direct review accepts this as the strongest current foundation but rejects finished quality because the outer gable still reads as a rectangular front below its roof, the arrival exposes a diagonal stair crossing as machinery, and gable-to-dome construction, interiors, and player staging still need professional resolution.',
      focus: 'Preserve the admitted whole-citadel topology, multi-minute route, connected occupation, mountain mantles, curved circulation, inhabited stair basilicas and loggias, perforated gables, differentiated narthexes, crown drum, true-void facades, material whitelist, Nanite source, and simple collision while rebuilding the rectangular outer-gable front and exposed stair crossing as one inhabited cliff-load section bonded into the dome and crown.',
      capability: 'The native R9 lane owns one 1,920 x 1,120 x 702 m manufactured citadel with a 1,620 m direct pilgrimage span, occupied palace spines, portal-broken gate palaces, a curved inner ward, five institution-specific construction modes, seven great halls and undercrofts, and an inhabited ogival crown. All inherited curved shoulder flights remain inside four mantle-borne stair basilicas. Reusable rules now add eight occupied central-gable loggias and accesses, twenty-four loggia bays and recessed starmetal bearings, eight battered load shoulders, differentiated narthex screens, twenty-four roof triforia, four occupied roof galleries and curved accesses, twelve dome-springing ribs, and twenty-four bonded flank chapels. Deterministic material rules constrain visible output to obsidian gneiss, dressed stone, starmetal, and rare larimar. Blender begins from factory-empty state. No named-object exception, coordinate repair, straight substitution, output repair, or manual render LOD chain exists.',
      proof: 'R9 attempt 0073 carries a 1,354,604-triangle Nanite source, 9,672 collision triangles, a 1,943.5335635259771 m route taking 323.92226058766283 s at 6 m/s across thirteen chapters, 151 occupied floors, 65 vertical paths, and 54,992.061172986505 m of secondary walkability. Its exact plan is bd56250d and exact GLB is 30cfcbf7. Independent attempt 0074 reproduces the exact plan, GLB, report, topology, route proof, review HTML, and decoded RGBA pixels for all nineteen views; Blender/PNG container metadata nondeterminism is declared. Python syntax, two byte-identical warnings-as-errors application builds at ca25485a, two byte-identical test builds at bacad70f, the full native suite, native admission, JSON validation, and diff checks pass. Repository verification has the same eight inherited unwaived failures. Direct review confirms systemic occupied-loggia/load-shoulder progress but not gorgeousness, awe, wonder, Unreal readiness, terrain integration, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'The occupied loggias, recessed bearings, and battered load shoulders are coherent enough to preserve, but the outer gable still presents as a rectangular front below its roof.',
        'The crown-arrival view still exposes a diagonal stair crossing as machinery rather than an inhabited bridge, vaulted crossing, or enclosed landing hall.',
        'Forked springing ribs now connect the gable directionally to the dome, but their material, structural, daylight, and spatial union with the crown drum and ogival shell remains schematic.',
        'Two lower galleries now exist, but their chambers, daylight, arcade relationship, drainage, and player evidence do not yet read as convincing inhabited cliff fabric.',
      ...
      next: 'Continue the active WH-WO-0062 lane by replacing the rectangular outer-gable front with a battered stepped cliff-load section, turning the exposed stair crossing into inhabited circulation architecture, resolving gable-to-dome load/material/daylight continuity, varying whole-crown cadence through program and section, honestly proving the lower galleries, and completing program-owned interiors. Change reusable plan and generator rules; do not patch attempts 0073-0074, add object exceptions or manual LODs, conceal defects with cameras, claim Landscry integration without a pinned snapshot, or import it into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md',
        'WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260807-0017.json',
        'WH-HANDOFF-0077_MYTHIC_CORE_R9_INHABITED_LOGGIA_AND_LOAD_SHOULDER_SUBSTRATE.md',
        'Worldheart commit a939685 - Deepen Mythic Core inhabited crown loggias',
        'R9 plan sha256:bd56250dd7e3a9dd4829aa88611fc64b6a95db2bc8c27c2b54e03d2ab286837f',
        'R9 artifact sha256:3b95dd78340ac7a4d386080e96003fb10805f530b4d9a06080b6a814029b7052',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0073',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0074',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: 'a939685', date: '2026-08-07', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
