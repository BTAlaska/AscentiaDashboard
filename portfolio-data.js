...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    },
    {
      ...
      body: 'WH-WO-0062 attempt 0036 is the strongest technically admitted Mythic Core substrate. It regenerates from an empty DCC scene as a 1,620 m stone, starmetal, and larimar citadel with a 1,943.534 m / 323.922 s primary route, 103 occupied floors, 53 vertical paths, 49.864 km of secondary walkability, seven cathedral-scale halls and undercrofts, four faceted masonry crown load spines, twenty occupied crown terraces connected by sixteen curved supported quarry stairs, four occupied springing bridges, and two lower enclosure galleries with 132 pointed arch bays. It uses one 740,500-triangle Nanite source plus 6,968 collision triangles with no output repair, straight substitution, program overlap, or manual render LODs. Direct review records material systemic progress but remains red: the crown still reads too schematic and scaffold-like, the gallery view does not yet prove gorgeous inhabited cliff fabric, and program interiors and construction-scale materials remain under-resolved. Continue by changing owning grammar; do not patch attempt 0036, add manual LODs, conceal defects with cameras, or mutate Unreal/Landscry.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
      ...
      decision: false,
      why: 'R9 attempt 0036 proves that unified faceted masonry crown load paths, curved supported exterior circulation, and occupied lower enclosure galleries can all be generated systemically from an empty scene without output repair or manual LODs. Direct review isolates the next owning-system problem: the crown remains too scaffold-like and schematic, the gallery view does not yet prove convincing inhabited cliff fabric, and program interiors still lack professional construction-scale resolution.',
      prompt: String.raw`Continue WORLDHEART inside the active WH-WO-0062 R9 topology-reset lane. Do not treat attempt 0036 as gorgeous or visually accepted.

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0009.json, docs\worldheart\11_handoffs\WH-HANDOFF-0069_MYTHIC_CORE_R9_UNIFIED_CROWN_LOAD_PATH_AND_INHABITED_ENCLOSURE_SUBSTRATE.md, and only their routed dependencies. Inspect D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_citadel_r9\machine-attempt-0036, especially citadel_whole_r9.png, citadel_plan_r9.png, central_crown_r9.png, crown_shoulder_player_r9.png, south_enclosure_gallery_player_r9.png, west_approach_r9.png, crown_arrival_player_r9.png, archive_hall_player_r9.png, and foundry_hall_player_r9.png. Preserve attempts 0001-0036 as immutable evidence.

Preserve the 1,620 m direct span, exact 1,943.5335635259771 m / 323.92226058766283 s primary route, thirteen chapters, five integrated institutions, 103 occupied floors, 53 vertical paths, seven great halls/undercrofts/room sequences, 49.864 km secondary walkability, explicit structural hierarchy, protected sightlines, true-void facades, layered enclosure walls, two occupied wall walks, two lower galleries with 132 pointed bays, twenty occupied crown terraces, sixteen curved supported quarry stairs, four occupied springing bridges, four faceted masonry load spines, four separated ogival petals, seventy-two program-owned detail modules, program clearances, portal-broken gate palaces, pointed ceremonial thresholds, deterministic refusal/provenance, one Nanite source, and simple collision. Preserve the visible material whitelist: obsidian gneiss, dressed stone, starmetal, and rare infrastructural larimar. Do not claim terrain integration without a pinned Landscry snapshot.

Change the owning plan and reusable generator rules, not attempt 0036. Replace the remaining scaffold-like drum/crown expression with one convincingly inhabited mountain section while preserving cardinal clefts, masonry load paths, and walkable ambulatories. Spatially couple the lower enclosure galleries, pointed arcade, chambers, daylight, drains, and wall walks so a player view proves inhabited cliff architecture honestly. Deepen construction-scale joints, starmetal interfaces, larimar infrastructure, and program-owned architectural density in all five institutions without blocking circulation. Lower object or triangle counts are acceptable when architectural clarity improves.

Reject object-by-object fixes, coordinate exception tables, decorative applique used as structure, manual LOD1/LOD2 chains, camera concealment, and hand-authored rescue. Keep only the salvaged deterministic constructors, validation, refusal, provenance, topology, circulation, institutional builders, and curve/profile substrate from Fable; do not restore its visible composition or repair ladder. Manufacture only into a fresh append-only attempt under WORLDHEART_OUTPUT_PARENT. Inspect the whole, plan, gates, crown, shoulder circulation, enclosure gallery, crown arrival, archive hall, and foundry hall before replay. Require Python syntax, diff checks, focused and full native tests, two warnings-as-errors builds, repository verification with inherited failures disclosed, and artifact hygiene. Keep architecture, gorgeousness, awe, wonder, Unreal readiness, and every affected gate red until direct authorized visual review. Do not mutate Unreal, Landscry, ThemeForge, providers, SitePainter, dressing-factory files, or unrelated dirty worktree files. Close with the governed Worldheart record first, then reconcile all three portfolio surfaces, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      state: 'attention',
      phase: 'WH-WO-0062 active - R9 unified crown load path, supported shoulder circulation, and inhabited enclosure substrate technically admitted; direct visual acceptance withheld',
      summary: 'R9 attempt 0036 regenerates the admitted 1.62 km citadel from an empty DCC scene with four faceted masonry crown load spines, four occupied springing bridges, twenty occupied crown terraces connected by sixteen curved supported quarry stairs, two lower enclosure galleries with 132 pointed arch bays, layered enclosure walls and occupied wall walks, seventy-two program-specific modules, seven cathedral-scale halls and undercrofts, portal-broken gate palaces, true-void facades, and deterministic stone/starmetal/larimar rules. It preserves multi-minute traversal, connected occupation, protected sightlines, one Nanite source, and simple collision without output repair or manual LODs. Direct review records material systemic progress but rejects finished quality because the crown remains too scaffold-like, the gallery evidence is tunnel-like rather than convincing inhabited cliff fabric, and construction-scale materials and institutional interiors remain under-resolved.',
      focus: 'Preserve the admitted whole-citadel topology, multi-minute route, connected occupation, masonry crown load paths, curved supported shoulder circulation, explicit hierarchy, clear gates, true-void facades, program clearances, material whitelist, Nanite source, and simple collision while replacing the remaining schematic crown and enclosure interiors with one convincing occupied mountain section through reusable plan rules.',
      capability: 'The native R9 lane owns one 1,620 m citadel enclosure, occupied palace spines, portal-broken gate palaces, a curved inner ward, five institution-specific construction modes, seven great halls and undercrofts, and an inhabited ogival crown. It now generates four continuous faceted masonry crown load spines, four occupied springing bridges, twenty occupied shoulder terraces, sixteen curved solid quarry-stair ascents with smooth collision, two occupied lower enclosure galleries, 132 gallery arch bays, four gallery-to-wall-walk paths, six battered enclosure lifts, eight quarry courses, two wall walks, and seventy-two program-owned modules. Deterministic material rules constrain visible output to obsidian gneiss, dressed stone, starmetal, and rare larimar. Blender begins from factory-empty state. No named-object exception, coordinate repair, straight substitution, output repair, or manual render LOD chain exists.',
      proof: 'R9 attempt 0036 carries a 740,500-triangle Nanite source, 6,968 collision triangles, a 1,943.5335635259771 m route taking 323.92226058766283 s at 6 m/s across thirteen chapters, five construction modes, 103 occupied floors, 53 vertical paths, and 49,863.633506720114 m of secondary walkability. It reports seven great halls, seven undercrofts, seven room sequences, 72 program-detail modules, two occupied enclosure galleries, 132 gallery arch bays, four gallery vertical paths, twenty shoulder terraces, sixteen shoulder vertical paths, four springing bridges, four unified masonry load spines, 669 primary / 856 secondary / 662 tertiary structural members, 202 pointed and 50 rounded arch bays, portal-broken gate palaces, program clearances, and zero disconnected floors, unresolved joints, program overlaps, sightline intrusions, straight substitutions, manual corrections, or manual LOD entries. Python syntax, two byte-identical warnings-as-errors application builds at 07a1204c, a clean test build, the fresh full native suite, native admission, JSON validation, and diff checks pass. Repository verification has the same eight inherited unwaived failures. Direct review confirms material systemic progress but not gorgeousness, awe, wonder, Unreal readiness, terrain integration, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'The crown load path and exterior circulation are materially stronger, but the drum, petals, ambulatories, and lantern still read as a schematic scaffold rather than one finished occupied mountain section.',
        ...
        'No visually accepted R9 artifact, independent replay, clean Unreal import, or final material/lighting proof exists; the current gallery review is compositionally inadequate.',
      ...
      next: 'Continue the active WH-WO-0062 lane by replacing the schematic crown and enclosure interiors with one convincing occupied mountain section, honestly proving the lower galleries at player scale, and deepening construction-scale materials and program interiors. Change reusable plan and generator rules; do not patch attempt 0036, add object exceptions or manual LODs, conceal defects with cameras, claim Landscry integration without a pinned snapshot, or import it into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md',
        'WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0009.json',
        'WH-HANDOFF-0069_MYTHIC_CORE_R9_UNIFIED_CROWN_LOAD_PATH_AND_INHABITED_ENCLOSURE_SUBSTRATE.md',
        'Worldheart commit 8ddb63b - Unify Mythic Core crown load paths',
        'R9 plan sha256:60103ceab539962e3f4ddfb3a24c927066d963cc04351840abb8fa25fbf70148',
        'R9 artifact sha256:b21a1f78fba0d2353c73eee5a175d259b885c9189fad9f59ce5d683fb1f30545',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0036',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: '8ddb63b', date: '2026-08-06', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
