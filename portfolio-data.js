...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    },
    {
      ...
      body: 'WH-WO-0062 attempt 0029 is the strongest technically admitted Mythic Core substrate. It regenerates from an empty DCC scene as a 1,620 m stone, starmetal, and larimar citadel with a 1,943.534 m / 323.922 s primary route, 75 occupied floors, 33 vertical paths, 37.537 km of secondary walkability, seven cathedral-scale halls and undercrofts, an open ogival crown, portal-broken gate palaces, and ten pointed ceremonial thresholds. It uses one 519,036-triangle Nanite source plus 3,080 collision triangles with no object repair, straight substitution, program overlap, or manual render LODs. Direct review records major systemic progress but remains red: the crown is still more ribbed pavilion than mountain-grown architecture, enclosure/material depth is schematic, and occupied halls need richer program density. Continue at crown/stone mass integration, battered enclosure fabric, honest material depth, and program-owned interiors; do not patch attempt 0029, add manual LODs, conceal defects with cameras, or mutate Unreal/Landscry.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
      ...
      decision: false,
      why: 'R9 attempt 0029 proves that grand vertical section, cathedral-scale occupied halls, program clearances, an open ogival crown, portal-broken gate palaces, and pointed ceremonial thresholds can all be generated systemically from an empty scene without object repair or manual LODs. Direct review isolates the next owning-system problem: crown and enclosure stone mass still lack convincing mountain/cliff integration, materials remain schematic, and occupied halls need deeper program-owned density.',
      prompt: String.raw`Continue WORLDHEART inside the active WH-WO-0062 R9 topology-reset lane. Do not treat attempt 0029 as gorgeous or visually accepted.

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0007.json, docs\worldheart\11_handoffs\WH-HANDOFF-0067_MYTHIC_CORE_R9_SECTION_OCCUPATION_AND_THRESHOLD_SUBSTRATE.md, and only their routed dependencies. Inspect D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_citadel_r9\machine-attempt-0029, especially citadel_whole_r9.png, citadel_plan_r9.png, west_approach_r9.png, east_release_r9.png, crown_arrival_player_r9.png, archive_hall_player_r9.png, and foundry_hall_player_r9.png. Preserve attempts 0001-0029 as immutable evidence.

Preserve the 1,620 m direct span, exact 1,943.5335635259771 m / 323.92226058766283 s primary route, thirteen chapters, five integrated institutions, 75 occupied floors, 33 vertical paths, seven great halls/undercrofts/room sequences, 37.537 km secondary walkability, explicit structural hierarchy, protected sightlines, true-void facades, 34 tapered landform-response buttresses, eight separated ogival crown petals, program clearances, two 72 m portal-broken gate palaces, ten pointed ceremonial thresholds, deterministic refusal/provenance, one Nanite source, and simple collision. Preserve the visible material whitelist: obsidian gneiss, dressed stone, starmetal, and larimar; larimar remains rare and infrastructural. Keep the Landscry boundary honest: architecture may express quarry terraces, cliff buttresses, ridge roofs, and deep thresholds, but must not claim terrain integration without a pinned Landscry snapshot.

Change the owning plan and reusable generator rules, not attempt 0029. Make the crown an occupied mountain/cliff termination: supporting stone mass, carved voids, ridge shoulders, and lantern must share one load-bearing section rather than read as a ribbed pavilion. Replace plain enclosure fields with battered wall lifts, quarry coursing, deep galleries, drainage, and cliff/ridge transitions without blocking the west/east axes. Deepen material manufacture so gneiss, dressed stone, starmetal, and rare larimar remain visually distinct under honest review lighting. Add program-owned interior density—archive stacks/restoration, foundry furnaces/cranes/quench works, council witness seating, refuge domestic/care cells, and cistern pumps/valves—without blocking circulation. Lower object or triangle counts are acceptable when architectural clarity improves.

Reject object-by-object fixes, coordinate exception tables, decorative applique used as structure, manual LOD1/LOD2 chains, camera concealment, and hand-authored rescue. Keep Fable's compositions and repair ladder rejected; only its validated constructor recognition, polygon/self-intersection checks, deterministic refusal, provenance, and general curve/profile primitives remain salvageable. Manufacture only into a fresh append-only attempt under WORLDHEART_OUTPUT_PARENT. Inspect the whole, plan, both gates, crown arrival, archive hall, and foundry hall before replay. Require focused native tests, warnings-as-errors builds, repository verification with inherited failures disclosed, and artifact hygiene. Keep architecture, gorgeousness, awe, wonder, Unreal readiness, and every affected gate red until direct authorized visual review. Do not mutate Unreal, Landscry, ThemeForge, providers, SitePainter, dressing-factory files, or unrelated dirty worktree files. Close with the governed Worldheart record first, then reconcile all three portfolio surfaces, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      state: 'attention',
      phase: 'WH-WO-0062 active - R9 section, occupation, crown, and threshold substrate technically admitted; direct visual acceptance withheld',
      summary: 'R9 attempt 0029 regenerates the admitted 1.62 km citadel from an empty DCC scene with plan-owned terraces and vertical massing, seven cathedral-scale halls and undercrofts, program clearances, an open ogival crown, portal-broken gate palaces, pointed ceremonial thresholds, true-void facades, and a hermetic stone/starmetal/larimar material law. It preserves multi-minute traversal, connected occupation, protected sightlines, one Nanite source, and simple collision without object repair or manual LODs. Direct review records major architectural progress—the gate and crown arrival are open, and archive/foundry interiors prove enormous coherent sections—but still rejects finished quality because crown/mountain integration, enclosure fabric, material depth, and occupied program density remain inadequate.',
      focus: 'Preserve the admitted whole-citadel topology, multi-minute route, connected occupation, explicit hierarchy, clear gates, true-void facades, program clearances, material whitelist, Nanite source, and simple collision while deriving mountain-grown crown/stone mass, battered enclosure fabric, honest material depth, and richer program-owned interiors from reusable plan rules.',
      capability: 'The native R9 lane owns one 1,620 m citadel enclosure, occupied palace spines, two portal-broken transverse gate palaces, a curved inner ward, five integrated institution-specific construction modes, seven great halls and undercrofts, and an inhabited ogival crown. It generates the route, floors, vertical paths, tiered structures, terraces, ridge roofs, protected sightline omissions, curved circulation, true-void pointed/rounded facade bays, masonry thresholds and jambs, program clearances, crown petals/bands/grounding, material restrictions, collision, review views, and admission records from pregeometry plan rules. Blender begins from factory-empty state. No named-object exception, coordinate repair, straight substitution, object repair, or manual render LOD chain exists.',
      proof: 'R9 attempt 0029 carries 2,141 render objects, a 519,036-triangle Nanite source, 3,080 collision triangles, a 1,943.5335635259771 m route taking 323.92226058766283 s at 6 m/s across thirteen chapters, five construction modes, 75 occupied floors, 33 vertical paths, and 37,537.054539935874 m of secondary walkability. It reports seven great halls, seven undercrofts, seven room sequences, 107 vertical massing steps, 37 ridge roofs, 579 primary / 672 secondary / 654 tertiary structural members, 120 true-void facade bays (70 pointed, 50 rounded), 34 tapered landform-response buttresses, eight crown petals/pinnacles/grounding buttresses, three drum bands, two 72 m open gate-palace portals, ten pointed ceremonial thresholds, 10 m palace clearance, 5 m crown clearance, and zero disconnected floors, unresolved joints, program overlaps, sightline intrusions, straight substitutions, manual corrections, or manual LOD entries. Python compilation, two byte-identical warnings-as-errors application builds, a clean test build, the full native suite, native admission, JSON validation, and diff checks pass. Repository verification has the same eight inherited unwaived failures. Direct review confirms major systemic progress but not gorgeousness, awe, wonder, Unreal readiness, terrain integration, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'The crown still reads more as a ribbed pavilion than a mountain/cliff-grown occupied termination.',
        'Large enclosure faces and exterior material depth remain schematic despite stronger section and open thresholds.',
        'Occupied halls prove scale and circulation but still need rich program-owned architectural density and use.',
      ...
      next: 'Continue the active WH-WO-0062 lane at mountain-grown crown/stone mass, battered enclosure fabric, honest material depth, and program-owned interior density. Change reusable plan and generator rules; do not patch attempt 0029, add object exceptions or manual LODs, conceal defects with cameras, claim Landscry integration without a pinned snapshot, or import it into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'WH-WO-0062_MYTHIC_CORE_APEX_CITADEL_TOPOLOGY_RESET_R9.md',
        'WH-ATT-MYTHIC-CORE-APEX-CITADEL-R9-20260806-0007.json',
        'WH-HANDOFF-0067_MYTHIC_CORE_R9_SECTION_OCCUPATION_AND_THRESHOLD_SUBSTRATE.md',
        'Worldheart commit 1b40d11 - Deepen Mythic Core Apex architecture',
        'R9 plan sha256:c12331f82977a729a641302e27831058232bb06c66941bf99e6c6c40540ebdd9',
        'R9 artifact sha256:be7522ba952045c2fa4b97eca64fa97862d09c036bced316f54fc6b6e9d24de8',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_citadel_r9/machine-attempt-0029',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: '1b40d11', date: '2026-08-06', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
