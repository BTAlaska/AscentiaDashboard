...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    {
      level: 'active',
      title: 'Operate from D: and retain rollback sources',
      body: 'The active portfolio and ThemeForge family are verified under D:/Ascentia. Compatibility junctions are limited to complete targets; Game, Skin Forge, Landscry recovery, and legacy placeholder trees remain explicit source-retention exceptions. Source retirement is not authorized.',
      owner: 'Portfolio migration / AscentiaDashboard',
    },
    {
      level: 'critical',
    ...
    {
      level: 'active',
      title: 'Stabilize the active game branch',
      body: 'Ascentia had 42 local commits beyond its recorded upstream and six modified C++ files at survey time. Preserve ignored Unreal asset state, validate the current slice, then publish a precise handoff before starting another system.',
      owner: 'Ascentia',
    },
    {
      level: 'review',
  ...
  projects: [
    {
      ...
      blockers: [
        '42 commits ahead of the recorded upstream branch at survey time.',
        'Six modified C++ files were present in the working tree.',
        'The detailed dashboard data predates most July 6-17 work.',
        'Ignored Unreal Content changes can disappear from Git-based status reporting.',
      ],
      next: 'Finish or checkpoint the current C++ slice, run the narrow network/gameplay proof, record ignored asset state, and publish a new Ascentia dashboard evidence entry.',
      authority: 'D:/Ascentia/repos/game',
      evidence: [
        'Git HEAD 80c225b5 (2026-07-17) at survey time',
        'Docs/Evidence/Latest and network/public-profile records',
        'Docs/DesignerSurfaces/AetherMagic_README.md',
      ],
      snapshot: { branch: 'codex/designer-compendium', head: '80c225b5', date: '2026-07-17', dirty: 6, ahead: 42, behind: 0 },
    },
    {
      id: 'dashboard',
      ...
      next: 'Use the D: repo as the only dashboard authority, reconcile or intentionally retire archived commit 93a1b208, and retain both original C: sources until retirement is explicitly authorized.',
      authority: 'D:/Ascentia/repos/dashboard',
      evidence: [
        'Authoritative commit 26ad4ac (2026-07-06)',
        'Alternate clone commit 93a1b208 (2026-07-07), one commit ahead locally',
        'gap-data.js curated date 2026-07-05',
      ],
      snapshot: { branch: 'main', head: '26ad4ac', date: '2026-07-06', dirty: 0, ahead: 0, behind: 0 },
    },
    {
      id: 'landscry',
      name: 'Landscry v0.2',
      ...
      snapshot: { branch: 'agent/t1b-a-declared-boundary', head: '0d129822', date: '2026-07-17', dirty: 5, ahead: 0, behind: 0 },
    },
    {
      id: 'worldheart',
      name: 'Worldheart',
      ...
      snapshot: { branch: 'codex/master-architect-visual-r50', head: '63acf529', date: '2026-07-18', dirty: 0, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
      ...
      proof: 'The full working tree is preserved on D:. Its package build, eight no-credit smoke checks, and local HTTP surface pass from D:/Ascentia/repos/asset-factory; paid provider actions were not used.',
      blockers: [
      ...
      snapshot: { branch: 'main', head: 'b1821de5', date: '2026-06-21', dirty: 6, ahead: 1, behind: 0 },
    },
    {
      id: 'interfaceforge',
      ...
      focus: 'Marketplace packaging, clean-install evidence, architecture separation, and a deliberate sync path between the plugin repo and proving ground.',
      ...
      proof: 'The canonical repo is clean at commit 34471dc and passes descriptor/module/preset validation. All seven production files are content-identical across canonical, Game, and Skin copies after newline normalization; the successful UE 5.8 Game build compiled both equivalent modules.',
      blockers: [
        'MythicSkinForge is not under Git and mixes sample content, generated assets, caches, and the copied plugin.',
        'The workbench remains a large ownership monolith slated for service/adaptor extraction.',
        'Clean UE screenshots, demo video, API-key shipping policy, compatibility notes, and broader smoke coverage remain.',
      ],
      next: 'Declare the plugin repo canonical, choose a repeatable install/sync command for the proving ground, rebuild a clean test project, then capture the Marketplace evidence set.',
      ...
      evidence: [
        ...
        'Seven of seven compared tracked plugin files differed in MythicSkinForge',
      ],
      snapshot: { branch: 'claude/docs-accuracy', head: '34471dc', date: '2026-06-21', dirty: 0, ahead: null, behind: null },
    },
    {
      id: 'skinforge',
