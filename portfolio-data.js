...
window.PORTFOLIO_DATA = {
  ...
  priorities: [
    ...
    {
      level: 'attention',
      title: 'Worldheart: differentiate the admitted R7 architecture without hand repair',
      body: 'WH-WO-0060 attempt 0011 is a technically admitted Mythic Core Apex composition: five non-overlapping institutional complexes, fifteen curved wing runs, five courts, ten terminal towers, seven crown-grounding galleries, 8,303.947 m of connected program walkability, an exact 1,680.752 m pilgrimage route, one 1,193,076-triangle Nanite source, and explicit 4,284-triangle simple collision. It removes the blank R6 precinct slabs, allocates program sectors before geometry, preserves curved manufacture and systemic connections, and adds a shared facade-detail grammar without any object exception table or manual LOD chain. Independent attempt 0012 reproduces the plan, reports, GLB, route proof, and all 34 rendered pixel arrays. Direct review still withholds visual acceptance: the five institutions share too much wing vocabulary, secondary occupation and material depth are thin, and the crown needs greater architectural resolution. The next bounded pass must differentiate institutions and inhabited depth through generative program rules, not per-object repair, decoration-only applique, camera concealment, or Unreal mutation; every affected gate remains red or unattempted.',
      owner: 'Worldheart',
    },
    {
      level: 'active',
...
Required proof: capture readable 2560x1440-or-larger PIE frames for exploration plus combat/resource states, verify no clipping/overlap at the tested resolution, run the narrow HUD/player-path scenarios and scoped log scan, run the Win64 Development Editor build and Tools\governance\check_designer_surface_contract.py, and leave human taste/accessibility verdicts explicitly open where automation cannot decide them. Update the owning Designer Surface row and screenshot routing. Commit and push on green per Docs\rules\SOURCE_CONTROL.md, then perform the Portfolio Signal: update priorities/handoff/project consistently, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, update D:\Ascentia\ops\PIPELINE_STATUS.md with a file-editing tool, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    ...
    {
      id: 'worldheart-mythic-core-apex-composition-r7',
      title: 'Differentiate the Mythic Core R7 institutions and inhabited depth',
      target: 'Codex - D:\\Ascentia\\repos\\worldheart',
      decision: true,
      why: 'R7 attempt 0011 proves that Apex-scale exterior programs, courts, curved wings, crown grounding, walkability, collision, and non-overlap can be derived systemically. Direct review now isolates a more advanced architectural problem: archive, council, foundry, refuge, and service need distinct institutional sections, occupation patterns, thresholds, and facade rhythms instead of one shared procedural wing vocabulary.',
      prompt: String.raw`Continue WORLDHEART from the technically admitted R7 Apex composition without treating it as gorgeous or visually accepted.

MY DECISION: [AUTHORIZE R8 / REVIEW ATTEMPT 0011 / PAUSE]

Start in D:\Ascentia\repos\worldheart on codex/mythic-core-apex-composition-r7 at or after revision f039b6e. Read AGENTS.md, docs\worldheart\README.md, docs\worldheart\08_workorders\WH-WO-0060_MYTHIC_CORE_APEX_PROGRAM_MASSING_AND_CROWN_GROUNDING_R7.md, docs\worldheart\09_reviews\gates\WH-ATT-MYTHIC-CORE-APEX-COMPOSITION-R7-20260806-0002.json, docs\worldheart\11_handoffs\WH-HANDOFF-0063_MYTHIC_CORE_APEX_COMPOSITION_R7_TECHNICAL_CANDIDATE.md, and only their routed dependencies. Inspect D:\Ascentia\data\worldheart-output\master_architect_mythic_core_apex_composition_r7\machine-attempt-0011 and independent replay 0012, including all whole/site, court, player-height, section, and crown-grounding evidence. Preserve attempts 0001-0012 as immutable evidence.

Preserve the exact 1,680.752065798395 m pilgrimage route, 280.1253442997325 s traversal at 6 m/s, fifteen chapters, R6 lineage, pregeometry non-overlapping program allocation, five complexes, fifteen curved wing runs, five courts, ten terminal towers, seven crown galleries, 8,303.946596156502 m connected program walkability, analytical joint/solid-void/framing refusal machinery, one full-detail Nanite source, and explicit simple collision. Author a new bounded accepted work order before mutation. Derive institution-specific architecture from program and use: distinct plan/section families, thresholds, circulation hierarchy, occupied edge depth, service and civic subspaces, facade bay rhythms, roof/crown responses, and structural consequences for archive, council, foundry, refuge, and service/cistern. Keep all differences rule-generated from semantic program records; reject object-by-object correction, exception tables, arbitrary applique, camera concealment, manual LOD chains, and hand-authored rescue.

Manufacture into a new append-only lane under WORLDHEART_OUTPUT_PARENT. Directly inspect high-key whole/site, both approaches, each institution from exterior and player height, occupied interiors/thresholds, the sanctuary crown, unified section, and route crossing before replay. Require focused native tests, warnings-as-errors builds, repository verification with inherited failures disclosed, independent rebuild, and artifact hygiene. Keep gorgeousness, awe, wonder, Unreal readiness, and all affected gates red until direct authorized visual review. Do not mutate Unreal, Landscry, ThemeForge, providers, SitePainter, dressing-factory files, or Fable's untracked revision chain. Reuse only Fable's validated constructor recognition, polygon/self-intersection checks, deterministic refusal, and general curve/profile primitives; do not admit its compositions. Update governed Worldheart records first, then reconcile all three portfolio surfaces, run refresh-portfolio.ps1, check-links.ps1, a JavaScript syntax smoke, and sweep artifacts per D:\Ascentia\ops\ARTIFACT_HYGIENE.md.`,
    },
    {
...
In D:\Ascentia\repos\landscry (read AGENTS.md and the mountain-region lane row in D:\Ascentia\ops\PIPELINE_STATUS.md first): the validated 16-tile UE window package t4b-native-de1c19affdbe624b sits in artifacts\mountain-region-20260718 (225 MB, 80 artifacts, all checks green, same source identity as the review bundle). Run the import: one source round of 16 tiles + the WP MeshPartition builder with ByPackageHash reuse (verify-don't-resave definition assets) + optional HLOD pass as ONE BUILDER PROCESS PER HLOD ACTOR via -BuildSingleHLOD (labels carry the <HLODLayer>/ prefix) + inspect with the winding gate. Gotchas: editing anything under crates/ + Cargo + fixtures mid-build forks the engine cache identity; close editors before headless builds (Live Coding patch-DLL law; bypass flag is -NoHotReloadFromIDE); the terrain/water MATERIAL is still the open T4b presentation gate — this import proves geometry and streaming, not final look. Deliver a lit, flyable level plus its path for me to fly myself — renders are internal verification only. Close out with the Portfolio Signal.`,
  ...
  projects: [
    ...
    },
    {
      ...
      next: 'ENGINE FIX SHIPPED (2026-08-06): your water-above-terrain report traced to a real defect - flagship bundles published water solved BEFORE erosion carved the terrain ~200 m deeper (lakes hung 195 m above their shores, rivers carried upstream elevations). The t4b path now re-solves water on the exact surface it publishes, refuses inconsistent bundles, and discloses the re-pond in the manifest. Fixed flagship t4b-flagship-78ee51c0bf629b62: max shore deficit 0.000 m, 32 contained lakes, UE package re-exported and validation PASSED. Viewer rewritten the same morning (true water pass, median decimation, no floating slabs or edge spikes). Conformance evidence regenerated, all ladders monotone. Restart your :4970 server to pick everything up. Queued: TEX-03 badland texture, sediment-lane question (erosion pins old lakebeds as mesas), OG-1 credential unlocks live composition.',
      ...
      snapshot: { branch: 'agent/s1-sediment', head: 'aa46ee0', date: '2026-08-06', dirty: 0, ahead: 0, behind: 0 },
    },
    {
      id: 'worldheart',
      name: 'Worldheart',
      ...
      state: 'attention',
      phase: 'WH-WO-0060 closed - R7 technically admitted, direct visual acceptance withheld',
      summary: 'R7 attempt 0011 turns the admitted R6 spine into a broad Apex-scale composition with five allocated institutional complexes, curved exterior wings and courts, terminal towers, and a grounded sanctuary crown. It systemically resolves the visible disconnections, straight substitutes, blank precinct slabs, and program overlap, but direct review still withholds visual acceptance because the institutions share too much vocabulary and lack enough occupied and material depth.',
      focus: 'Preserve the admitted R7 scale, route, program allocation, curved manufacture, connectivity, non-overlap, Nanite-source, and collision grammar while deriving distinct institutional plans, sections, thresholds, facade rhythms, occupation, and structural consequences from semantic program rules.',
      capability: 'The native lane now owns route-first reservation plus pregeometry allocation of five non-overlapping program sectors; fifteen curved wing runs, five courts, side aisles and transepts, continuous floors, supports, transverse arches, roof webs, eaves, terminal towers, 416 longitudinal facade arches, 96 stringcourses, and seven walkable crown-grounding galleries. It measures curved corridor occupancy and sightline support planes, refuses unresolved program placement, emits deterministic player evidence, and preserves one full-detail Nanite source with explicit simple collision and no manual render LOD chain. The exact 1,680.752 m pilgrimage and fifteen chapters remain intact.',
      proof: 'R7 attempt 0011 carries 3,323 render objects, 63 collision objects, a 1,193,076-triangle Nanite source, 4,284 collision triangles, five complexes, fifteen curved wing runs, five courts, ten terminal towers, 446 supports, 223 transverse arches, 208 roof webs, 416 facade arches, 96 stringcourses, seven crown galleries, and 8,303.946596156502 m connected program walkability. It reports zero program overlaps, route intrusions, circulation breaks, or unresolved program joints; all eleven R7 review views and 34 total render surfaces are admitted. Attempt 0012 independently reproduces the plan, joint, solid/void, framing, program admission, program framing, GLB, route proof, report, and decoded pixels of all 34 PNGs; Blender container bytes and aggregate receipt identity differ and total byte determinism is not claimed. Release warnings-as-errors builds, the full native suite, Python compilation, dependency manifests, and diff checks pass. Repository verification retains eight inherited/mixed-worktree plan/index/manifest failures. Direct inspection confirms grand connected curved massing and readable courts, but not final institutional distinction, inhabited depth, material richness, gorgeousness, awe, wonder, Unreal readiness, or human acceptance; every affected gate remains red or unattempted.',
      blockers: [
        'Archive, council, foundry, refuge, and service still read as variations of one shared procedural wing family rather than distinct institutions.',
        'Secondary occupation, inhabited edge depth, thresholds, service spaces, and use-specific interior hierarchy are not yet rich enough.',
        'Facade, roof, and crown detail remain structurally coherent but materially and architecturally prototypal.',
        'No visually accepted R7 artifact, clean Unreal import, or final material/lighting proof exists.',
      ...
      next: 'Choose whether to authorize one bounded R8 institutional-differentiation and inhabited-depth pass, directly review R7 attempt 0011, or pause. Do not hand-edit, decorate, camera-conceal, add manual LODs, or import attempt 0011 into Unreal.',
      authority: 'D:/Ascentia/repos/worldheart',
      evidence: [
        'Git R7 implementation revision 931898c and governed closeout revision f039b6e',
        'WH-WO-0060_MYTHIC_CORE_APEX_PROGRAM_MASSING_AND_CROWN_GROUNDING_R7.md',
        'WH-ATT-MYTHIC-CORE-APEX-COMPOSITION-R7-20260806-0002.json',
        'WH-HANDOFF-0063_MYTHIC_CORE_APEX_COMPOSITION_R7_TECHNICAL_CANDIDATE.md',
        'R7 plan sha256:0c73b7dd83699031ee64275f5a348082935b352ab528f6e8084c0d2e8fb284b2',
        'R7 artifact sha256:0209fe03917d41951575aa186a17bb24da8cfd9bd2ecafa1181d174bc73ba31d',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_composition_r7/machine-attempt-0011',
        'D:/Ascentia/data/worldheart-output/master_architect_mythic_core_apex_composition_r7/machine-attempt-0012',
      ],
      snapshot: { branch: 'codex/mythic-core-apex-composition-r7', head: 'f039b6e', date: '2026-08-06', dirty: null, ahead: null, behind: null },
    },
    {
      id: 'assetfactory',
