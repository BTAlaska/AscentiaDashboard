...
const GAP_DATA = [
  { id: 'content-spine', name: 'P0/P23 Content Spine & Publication Gates', icon: '#', features: [
    ...
    { f: 'World import preflight gate', s: 'missing', plan: 'P0/P23+P17', n: 'Before serious Landscry/P17 content, require zone identity, Data Layers, HLOD layers, PCG provenance, persistent actor IDs, nav/smart-object builder pass, and cook-risk report. Game World Asset Factory generation is stopped and locked: Worldheart owns structures, Meshy authors atomic terrain/PCG meshes, props, and reviewed attachments, and PCG/manual placement owns rubble/debris composition. Its v4 catalog has 891 Meshy 6 Nanite-active, 90 T2-paused, and 180 historical review-only plans, including a 36-form Physical geology expansion. The reference path is currently one Images 2 image into Meshy single-image reconstruction; multi-view is unimplemented. Fifty completed candidates stand at 6 Keep / 0 Reject / 44 awaiting exact-output review; 29 structural packages remain historical quarantine only. Even Keep supplies no Nanite, collision, PCG-placement, Worldheart-mount, Unreal-import, or production proof; the world gate remains missing.' },
  ]},
