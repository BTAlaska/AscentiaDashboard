...
const GAP_DATA = [
  { id: 'content-spine', name: 'P0/P23 Content Spine & Publication Gates', icon: '#', features: [
    ...
    { f: 'World import preflight gate', s: 'missing', plan: 'P0/P23+P17', n: 'Before serious Landscry/P17 content, require zone identity, Data Layers, HLOD layers, PCG provenance, persistent actor IDs, nav/smart-object builder pass, and cook-risk report. Game World Asset Factory generation is stopped and locked after the owner assigned buildings and structural meshes to Worldheart. Its v3 catalog now contains only terrain/PCG meshes and props; 50 completed packages remain current candidates while 29 structural packages are historical quarantine only. This supplies no Nanite, collision, PCG-placement, Worldheart-mount, Unreal-import, or production proof; the world gate remains missing.' },
  ]},
