...
const DASHBOARD_SUMMARY = {
  ...
  lastSourceCommit: 'db4d8b7 external-only Aether residue refill (local closeout; one ahead of origin pending external-origin approval)',
